...
function createResponse(request, body) {
  const responseBodyOrNull = _chunkNZ7OXVVLjs.FetchResponse.isResponseWithBody(request.status) ? body : null;
  return new (0, _chunkNZ7OXVVLjs.FetchResponse)(responseBodyOrNull, {
...
var XMLHttpRequestController = class {
  ...
  toFetchApiRequest(body) {
    ...
    Reflect.set(fetchRequest, _chunkNZ7OXVVLjs.kRawRequest, this.request);
...
var _XMLHttpRequestInterceptor = class extends _chunkTIPR373Rjs.Interceptor {
  ...
  setup() {
    ...
    _outvariant.invariant.call(void 0, 
      !PureXMLHttpRequest[_chunkNZ7OXVVLjs.IS_PATCHED_MODULE],
    ...
    Object.defineProperty(globalThis.XMLHttpRequest, _chunkNZ7OXVVLjs.IS_PATCHED_MODULE, {
      enumerable: true,
      configurable: true,
      value: true
    });
