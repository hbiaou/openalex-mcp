...
var _FetchInterceptor = class extends _chunkTIPR373Rjs.Interceptor {
  ...
  async setup() {
    ...
    _outvariant.invariant.call(void 0, 
      !pureFetch[_chunkNZ7OXVVLjs.IS_PATCHED_MODULE],
      'Failed to patch the "fetch" module: already patched.'
    );
    globalThis.fetch = async (input, init) => {
      const requestId = _chunkTIPR373Rjs.createRequestId.call(void 0, );
      const resolvedInput = typeof input === "string" && typeof location !== "undefined" && !_chunkNZ7OXVVLjs.canParseUrl.call(void 0, input) ? new URL(input, location.href) : input;
      ...
      const isRequestHandled = await _chunkGTJ35JP4js.handleRequest.call(void 0, {
        ...
        onResponse: async (rawResponse) => {
          ...
          const response = decompressedStream === null ? rawResponse : new (0, _chunkNZ7OXVVLjs.FetchResponse)(decompressedStream, rawResponse);
          _chunkNZ7OXVVLjs.FetchResponse.setUrl(request.url, response);
          if (_chunkNZ7OXVVLjs.FetchResponse.isRedirectResponse(response.status)) {
    ...
    Object.defineProperty(globalThis.fetch, _chunkNZ7OXVVLjs.IS_PATCHED_MODULE, {
      enumerable: true,
      configurable: true,
      value: true
    });
