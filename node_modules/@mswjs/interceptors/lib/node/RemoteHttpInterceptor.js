...
var _chunkHAXZ5BCLjs = require('./chunk-HAXZ5BCL.js');


var _chunkTBQOE5KZjs = require('./chunk-TBQOE5KZ.js');


var _chunkNH6SN3VBjs = require('./chunk-NH6SN3VB.js');
require('./chunk-LK6DILFK.js');


var _chunkEAFENFG6js = require('./chunk-EAFENFG6.js');
...
var RemoteHttpInterceptor = class extends _chunkHAXZ5BCLjs.BatchInterceptor {
  constructor() {
    super({
      name: "remote-interceptor",
      interceptors: [
        new (0, _chunkTBQOE5KZjs.ClientRequestInterceptor)(),
        new (0, _chunkNH6SN3VBjs.XMLHttpRequestInterceptor)(),
        new (0, _chunkEAFENFG6js.FetchInterceptor)()
      ]
    });
  }
  setup() {
      ...
      const responsePromise = new Promise((resolve) => {
        handleParentMessage = (message) => {
          ...
          if (message.startsWith(`response:${requestId}`)) {
            ...
            const mockedResponse = new (0, _chunkQFLITAVVjs.FetchResponse)(responseInit.body, {
              url: request.url,
...
var _RemoteHttpResolver = class extends _chunkQFLITAVVjs.Interceptor {
  constructor(options) {
