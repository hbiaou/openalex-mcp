...
// src/interceptors/fetch/index.ts
var _FetchInterceptor = class extends _chunkQFLITAVVjs.Interceptor {
  constructor() {
  ...
  async setup() {
    ...
    globalThis.fetch = async (input, init) => {
      ...
      const resolvedInput = typeof input === "string" && typeof location !== "undefined" && !_chunkQFLITAVVjs.canParseUrl.call(void 0, input) ? new URL(input, location.href) : input;
      const request = new Request(resolvedInput, init);
      if (input instanceof Request) {
        Reflect.set(request, _chunkQFLITAVVjs.kRawRequest, input);
      }
      ...
      const isRequestHandled = await _chunkC2JSMMHYjs.handleRequest.call(void 0, {
        ...
        onResponse: async (rawResponse) => {
          ...
          const response = decompressedStream === null ? rawResponse : new (0, _chunkQFLITAVVjs.FetchResponse)(decompressedStream, rawResponse);
          _chunkQFLITAVVjs.FetchResponse.setUrl(request.url, response);
          if (_chunkQFLITAVVjs.FetchResponse.isRedirectResponse(response.status)) {
...
//# sourceMappingURL=chunk-EAFENFG6.js.map