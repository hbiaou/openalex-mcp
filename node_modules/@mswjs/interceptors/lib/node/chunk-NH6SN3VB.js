...
function createResponse(request, body) {
  const responseBodyOrNull = _chunkQFLITAVVjs.FetchResponse.isResponseWithBody(request.status) ? body : null;
  return new (0, _chunkQFLITAVVjs.FetchResponse)(responseBodyOrNull, {
...
var XMLHttpRequestController = class {
  constructor(initialRequest, logger) {
    ...
    this.requestId = _chunkQFLITAVVjs.createRequestId.call(void 0, );
              ...
              if (!this[kIsRequestHandled]) {
                ...
                if (IS_NODE) {
                  this.request.setRequestHeader(
                    _chunkQFLITAVVjs.INTERNAL_REQUEST_ID_HEADER_NAME,
                    this.requestId
                  );
                }
                return invoke();
  ...
  toFetchApiRequest(body) {
    ...
    Reflect.set(fetchRequest, _chunkQFLITAVVjs.kRawRequest, this.request);
...
// src/interceptors/XMLHttpRequest/index.ts
var _XMLHttpRequestInterceptor = class extends _chunkQFLITAVVjs.Interceptor {
  constructor() {
...
//# sourceMappingURL=chunk-NH6SN3VB.js.map